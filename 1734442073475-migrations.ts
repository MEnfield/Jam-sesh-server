...
export class Migrations1734442073475 implements MigrationInterface {
    name = 'Migrations1734442073475'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "events" ALTER COLUMN "location" TYPE geometry`);
        await queryRunner.query(`ALTER TABLE "profiles" ALTER COLUMN "location" TYPE geometry`);
        ...
        await queryRunner.query(`ALTER TABLE "locations" ADD "coordinates" geometry(Point,4326)`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "locations" DROP COLUMN "coordinates"`);
        await queryRunner.query(`ALTER TABLE "locations" ADD "coordinates" geography(Geometry,0)`);
        await queryRunner.query(`ALTER TABLE "users" DROP CONSTRAINT "UQ_074a1f262efaca6aba16f7ed920"`);
        await queryRunner.query(`ALTER TABLE "profiles" ALTER COLUMN "location" TYPE geometry(GEOMETRY,0)`);
        await queryRunner.query(`ALTER TABLE "events" ALTER COLUMN "location" TYPE geometry(GEOMETRY,0)`);
    }
